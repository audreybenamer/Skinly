...
public class RoutineAdapterPM extends RealmRecyclerViewAdapter<ProductsClass, RoutineAdapterPM.ViewHolder> {

    // IMPORTANT
    // THE CONTAINING ACTIVITY NEEDS TO BE PASSED SO YOU CAN GET THE LayoutInflator(see below)
    DailyScreen activity;

    public RoutineAdapterPM(DailyScreen activity, @Nullable OrderedRealmCollection<ProductsClass> data, boolean autoUpdate) {
