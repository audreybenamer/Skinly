...
public class EditRoutineAdapterAM extends RealmRecyclerViewAdapter<ProductsClass, EditRoutineAdapterAM.ViewHolder> {
    ...
    public EditRoutineAdapterAM(EditDailyScreen activity, @Nullable OrderedRealmCollection<ProductsClass> data, boolean autoUpdate) {
